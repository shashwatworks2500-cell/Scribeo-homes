...
const SECTIONS: Entry[] = [
  ...
  { id: "s-specs", kind: "Section", title: "Specifications",
    detail: "What the building is made of", href: "#specifications",
    tags: ["specification", "spec", "materials", "structure", "flooring", "parking", "security", "what is included"] },
  { id: "s-why", kind: "Section", title: "Why here",
    detail: "Six decisions, made once", href: "#why",
    tags: ["why", "different", "principles", "reasons", "usp"] },
  { id: "s-faq", kind: "Section", title: "Questions",
    detail: `${FAQS.length} answers, searchable`, href: "#faq",
    tags: ["faq", "questions", "answers", "help"] },
  { id: "s-trust", kind: "Section", title: "Before you decide",
