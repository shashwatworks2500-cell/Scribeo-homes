...
export type GalleryItem = Asset & { category: string; caption: string; drawing?: boolean };

const g = (a: Asset, category: string, caption: string): GalleryItem => ({ ...a, category, caption });
...
export const GALLERY: GalleryItem[] = [
  g(A.masterReference, "Exteriors", "The development at first light"),
  ...
  g(A.facadeStudy, "Exteriors", "The signature façade"),
  g(A.vFacade, "Exteriors", "Three storeys of one bay"),
  g(A.lifestyleArrival, "Exteriors", "Arrival on foot"),

  g(A.livingRoom, "Interiors", "The sheltered living terrace"),
  g(A.indoorOutdoor, "Interiors", "The threshold, drawn back"),
  ...
  g(A.garden, "Landscape", "The garden at the heart"),
  ...
  g(A.amPool, "Amenities", "The lap pool"),
