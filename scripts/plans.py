...
PLANS = {
 ...
 "plan-3bhk": dict(
   ...
   rooms=[(0,0,7.6,1.8,"Balcony","out"),(0,1.8,7.6,5.2,"Living & Dining","dry"),
          (7.6,0,7.0,3.6,"Kitchen","dry"),(7.6,3.6,3.4,3.4,"Utility","wet"),
   ...
   doors=[(3.0,1.8,1.2,0.06),(7.6,2.0,0.06,1.0),(7.6,4.6,0.06,0.9),(11.0,4.6,0.06,0.9),
 ...
 "plan-4bhk": dict(
   ...
   rooms=[(0,0,8.4,2.0,"Balcony","out"),(0,2.0,8.4,5.8,"Living & Dining","dry"),
          (8.4,0,8.8,3.8,"Kitchen","dry"),(8.4,3.8,4.0,4.0,"Utility","wet"),
   ...
   doors=[(3.4,2.0,1.3,0.06),(8.4,2.2,0.06,1.0),(8.4,5.2,0.06,0.9),(12.4,5.2,0.06,0.9),
